        ...
        const TOWER_TYPES = [
    { name: 'HACKER-0', baseCost: 50, upgrades: [ { damage: 12, range: 22, rate: 0.35, color: 0x00ffff, cost: 0 }, { damage: 28, range: 27, rate: 0.28, color: 0x00ddff, cost: 80 }, { damage: 55, range: 32, rate: 0.22, color: 0x0088ff, cost: 150 } ], projectileSpeed: 60, shape: 'sniper' },
    { name: 'HACKER-1', baseCost: 100, upgrades: [ { damage: 18, range: 14, rate: 1.2, color: 0xffff00, cost: 0, scatter: 3, spread: 0.3 }, { damage: 32, range: 17, rate: 1.0, color: 0xffcc00, cost: 180, scatter: 5, spread: 0.4 }, { damage: 55, range: 20, rate: 0.85, color: 0xff8800, cost: 320, scatter: 7, spread: 0.5 } ], projectileSpeed: 35, shape: 'cannon' },
    { name: 'HACKER-X', baseCost: 180, upgrades: [ { damage: 30, range: 13, rate: 2.2, color: 0xff00ff, cost: 0, aoe: 6 }, { damage: 60, range: 16, rate: 1.8, color: 0xff00cc, cost: 240, aoe: 8 }, { damage: 110, range: 19, rate: 1.5, color: 0xff0088, cost: 420, aoe: 11 } ], projectileSpeed: 18, shape: 'sphere' },
    { name: 'HACKER-L', baseCost: 160, upgrades: [ { damage: 6, range: 26, rate: 0.08, color: 0xff0000, cost: 0, beam: true, pierce: 2 }, { damage: 12, range: 32, rate: 0.06, color: 0xff3300, cost: 210, beam: true, pierce: 4 }, { damage: 22, range: 38, rate: 0.05, color: 0xff6600, cost: 380, beam: true, pierce: 7 } ], projectileSpeed: 120, shape: 'laser' },
    { name: 'HACKER-S', baseCost: 140, upgrades: [ { damage: 4, range: 22, rate: 0.5, color: 0x00ff88, cost: 0, slow: 0.5, slowDuration: 2.5 }, { damage: 8, range: 28, rate: 0.4, color: 0x00ffaa, cost: 170, slow: 0.35, slowDuration: 3.5 }, { damage: 14, range: 34, rate: 0.32, color: 0x00ffcc, cost: 300, slow: 0.22, slowDuration: 4.5 } ], projectileSpeed: 28, shape: 'ring' },
    { name: 'HACKER-C', baseCost: 220, upgrades: [ { damage: 35, range: 17, rate: 2.0, color: 0xccff00, cost: 0, chain: 3, chainRange: 9 }, { damage: 65, range: 21, rate: 1.6, color: 0xaaff00, cost: 270, chain: 5, chainRange: 11 }, { damage: 115, range: 25, rate: 1.3, color: 0x88ff00, cost: 460, chain: 8, chainRange: 14 } ], projectileSpeed: 50, shape: 'coil' }
];
        ...
        // === NEBEL WOLKEN & GLITZER PARTIKEL ===
        let fogClouds = [];
        let glitterParticles = [];

        function createFogClouds() {
            console.log('☁️ Creating Fog Clouds...');
            ...
            console.log('✅ Created', fogClouds.length, 'fog clouds');
            return cloudGroup;
        }
        ...
        function createGlitterParticles() {
            console.log('✨ Creating Glitter Particles...');
            ...
            console.log('✅ Created', glitterParticles.length, 'glitter particles');
